...
public class frm38 extends JFrame {
    ...
    JTextField txtMes, txtAno, txtNombreMes, txtDias;
    ...
    public frm38() {
        ...
        txtAno.setBounds(180, 70, 150, 30);
        txtAno.setHorizontalAlignment(SwingConstants.RIGHT);
        txtAno.setMargin(new Insets(5, 5, 5, 5));
